...
public class RegisterUser extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        try{
            ...
            PreparedStatement pstmt=con.prepareStatement("insert into user_details(name,mobile_no,email_id,username,password) values(?,?,?,?,?)");
            pstmt.setString(1,jTextField1.getText());
            pstmt.setLong(2,Long.parseLong(jTextField2.getText()));
            pstmt.setString(3,jTextField3.getText());
            pstmt.setString(4,jTextField4.getText());
            pstmt.setString(5,jTextField5.getText());
            int rs=pstmt.executeUpdate();
            if(rs>0){
                javax.swing.JOptionPane.showMessageDialog(null,"You have Successfully Registered!!","Registeration Successful!",javax.swing.JOptionPane.INFORMATION_MESSAGE);
                setVisible(false);
            ...
            javax.swing.JOptionPane.showMessageDialog(null,e,"Registration Unsuccessful!",javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    }                                        
